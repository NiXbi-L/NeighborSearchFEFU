...
async def gpt(promt):
    ...
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[{"role": "user",
                   "content": f"Тебе нужно побыть в роли модератора сайта для поиска соседа в общежитии тебе нужно будет проверить подходит ли анкета чтобы ее увидели другие люди."
                              f"Анкета может не содержать интересов тк в этом разделе сайта люди ищут соседей и пишут в основном бытовые вещи."
